...
public class VitamioPlayerActivity extends BaseActivity {
    ...
    public int getLayoutId() {
        return R.layout.activity_vitamioplayer;
    }
    ...
    public void initView() {
        ...
        mLoadLayout = (LinearLayout) findViewById(R.id.ll_player_loading);
        mBufferBar = (ProgressBar) findViewById(R.id.pb_buffer);
    ...
    public void initListener() {
        ...
        //视频缓冲监听
        mVideoView.setOnBufferingUpdateListener(new VideoOnBufferingUpdateListener());
     ...
     * 视频缓冲监听器
     */
    private class VideoOnBufferingUpdateListener implements MediaPlayer.OnBufferingUpdateListener {
        @Override
        public void onBufferingUpdate(MediaPlayer mp, int percent) {
            // 计算缓冲百分比
            float bufferPercent = percent / 100f;
            // 计算缓冲了多少时间
            int bufferTime = (int) (bufferPercent * mPlayTimeBar.getMax());
            // 更新第二进度条
            mPlayTimeBar.setSecondaryProgress(bufferTime);
        }
    }
    ...
    private class VideoOnCompletionListener implements MediaPlayer.OnCompletionListener {
        ...
        public void onCompletion(MediaPlayer mp) {
            ...
            updateBarPosition((int) mp.getDuration());
            //更新播放/暂停图标
            updatePauseBtn();
            //停止时间更新Handler
            mHanlder.removeMessages(UPDATE_PLAYER_TIME);
    ...
    private void updateBarPosition(int currentPosition) {
        ...
        //设置当前进度条
        mPlayTimeBar.setProgress((int) mVideoView.getCurrentPosition());
    }
